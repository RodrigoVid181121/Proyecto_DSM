...
fun PokeModelDetails.toDomain(): PokeItemDetails{
    ...
    val img = sprites.other.artwork.img
    val hp = details[0].statValue
    val attack = details[1].statValue
    val defense = details[2].statValue
    val specialAttack = details[3].statValue
    val specialDefense = details[4].statValue
    val speed = details[5].statValue
